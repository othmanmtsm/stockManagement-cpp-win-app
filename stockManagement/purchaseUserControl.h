...
namespace stockManagement {
	...
	/// <summary>
	/// Summary for purchaseUserControl
	/// </summary>
	public ref class purchaseUserControl : public System::Windows::Forms::UserControl
	{
	public:
		purchaseUserControl(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(purchaseUserControl::typeid));
			...
			this->bunifuImageButton2->Click += gcnew System::EventHandler(this, &purchaseUserControl::bunifuImageButton2_Click);
			// 
			// panel11
			// 
			...
			this->bunifuImageButton1->Click += gcnew System::EventHandler(this, &purchaseUserControl::bunifuImageButton1_Click);
			// 
			// flowLayoutPanel1
			// 
			...
			this->AddProduct->Click += gcnew System::EventHandler(this, &purchaseUserControl::AddProduct_Click);
			// 
			// panel7
			// 
			...
			this->bunifuMetroTextbox1->OnValueChanged += gcnew System::EventHandler(this, &purchaseUserControl::bunifuMetroTextbox1_OnValueChanged);
			this->bunifuMetroTextbox1->Enter += gcnew System::EventHandler(this, &purchaseUserControl::bunifuMetroTextbox1_Enter);
			// 
			// panel6
			// 
			...
			this->label1->Size = System::Drawing::Size(146, 35);
			this->label1->TabIndex = 9;
			this->label1->Text = L"Purchase";
			// 
			// panel10
			// 
			...
			this->Name = L"purchaseUserControl";
			this->Size = System::Drawing::Size(1299, 736);
			this->Load += gcnew System::EventHandler(this, &purchaseUserControl::purchaseUserControl_Load);
...
private: System::Void purchaseUserControl_Load(System::Object^ sender, System::EventArgs^ e) {
	getPur();
}

private: System::Void AddProduct_Click(System::Object^ sender, System::EventArgs^ e) {
	PurchaseAdd^ add = gcnew PurchaseAdd();
	add->Show();
}
private: System::Void bunifuImageButton1_Click(System::Object^ sender, System::EventArgs^ e) {
	PurchaseModify^ modify = gcnew PurchaseModify(ProductGridView->CurrentRow->Cells[0]->Value->ToString());
	modify->Show();
}
...
void getPur() {
	cnx->Open();
	SqlDataAdapter^ da = gcnew SqlDataAdapter("select a.idA as 'id', p.libel as 'Product', f.name as 'Supplier', a.CoutU as 'Unit Price', a.quantity as 'Quantity' from Produit p join Achat a on p.idP=a.idProduit join Fournisseur f on a.idFourni=f.idF", cnx);
...
private: System::Void bunifuImageButton2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		SqlCommand^ cmd = gcnew SqlCommand("delete from Achat where idA=@id", cnx);
...
private: System::Void bunifuMetroTextbox1_OnValueChanged(System::Object^ sender, System::EventArgs^ e) {
	((DataTable^)ProductGridView->DataSource)->DefaultView->RowFilter = String::Format("Product like '%{0}%' or Supplier like '%{0}%'", bunifuMetroTextbox1->Text);
}
};
}
