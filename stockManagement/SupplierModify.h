...
namespace stockManagement {
	...
	/// <summary>
	/// Summary for SupplierModify
	/// </summary>
	public ref class SupplierModify : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(SupplierModify::typeid));
			...
			this->bunifuFlatButton1->Click += gcnew System::EventHandler(this, &SupplierModify::bunifuFlatButton1_Click);
			// 
			// emailTx
			// 
			...
			this->cancelBtn->Click += gcnew System::EventHandler(this, &SupplierModify::cancelBtn_Click);
			// 
			// bunifuCustomLabel6
			// 
			...
			this->bunifuCustomLabel6->Text = L"Modify a Supplier";
			// 
			// jText_Box1
			// 
			...
			this->Name = L"SupplierModify";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"SupplierModify";
			this->Load += gcnew System::EventHandler(this, &SupplierModify::SupplierModify_Load);
...
private: System::Void SupplierModify_Load(System::Object^ sender, System::EventArgs^ e) {
	cnx->Open();
	SqlCommand^ cmd = gcnew SqlCommand("select name, lastname, adresse, email from Fournisseur where idF=@id", cnx);
...
private: System::Void bunifuFlatButton1_Click(System::Object^ sender, System::EventArgs^ e) {
	cnx->Open();
	SqlCommand^ cmd = gcnew SqlCommand("update Fournisseur set name=@name, lastname=@lastname, adresse=@address, email=@email where idF=@id", cnx);
	cmd->Parameters->AddWithValue("id", supplierID);
