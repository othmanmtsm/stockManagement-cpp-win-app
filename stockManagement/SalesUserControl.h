...
namespace stockManagement {
	...
	/// <summary>
	/// Summary for SalesUserControl
	/// </summary>
	public ref class SalesUserControl : public System::Windows::Forms::UserControl
	{
	public:
		SalesUserControl(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(SalesUserControl::typeid));
			...
			this->bunifuImageButton1->Click += gcnew System::EventHandler(this, &SalesUserControl::bunifuImageButton1_Click);
			// 
			// flowLayoutPanel1
			// 
			...
			this->AddProduct->Click += gcnew System::EventHandler(this, &SalesUserControl::AddProduct_Click);
			// 
			// panel7
			// 
